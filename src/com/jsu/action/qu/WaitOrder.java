...
public class WaitOrder {
	...
	public String showWaitOrder(){
		System.out.println("开始查询所有待收货剁手记录");
		//orders=dao.findOrderByType("b8c2d31ec34a",1);
		orders=dao.findOrderByType(id,type);
		 for(Order order : orders) {
			System.out.println(order.getTime());
		 }
			System.out.println("待收货剁手记录条数："+orders.size());
